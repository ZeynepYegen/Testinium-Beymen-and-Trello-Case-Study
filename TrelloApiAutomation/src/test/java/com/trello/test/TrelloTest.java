...
public class TrelloTest {
    ...
    public void createBoard() {
        String boardNameToCreate = "Zeynep'in Panosu";
        ...
        System.out.println("Board creation is successfull, board nameis : " + createdBoardName);
    }
    ...
    public void addListToBoard() {
        ...
        System.out.println("List creation is successfull, list name is: " + createdListName);
    }
