...
import com.testinium.helpers.ExcelReader;
...
public class Beymen {
    ...
    private static String filePath = "src/resources/excelTable.xlsx";
    ...
    public void searchProducts() throws InterruptedException {
        ...
        String searchKey1 = excelReader.getExcelValue(filePath, 0, 0, 0); // şort
        String searchKey2 = excelReader.getExcelValue(filePath, 0, 0, 1); // gömlek
